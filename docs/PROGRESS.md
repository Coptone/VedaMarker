...
- [ ] P0 in-game revalidation: all eight real Party Target Markers and clears through the 0.2.4 diagnostic
...
- Real marking remains experimental after the 0.2.2 in-game failure report. Version 0.2.3 corrected `stop1/stop2` to the game's `ignore1/ignore2`, localized every parameter, and added a 650ms clear-to-mark phase delay. Version 0.2.4 adds an all-eight marker/clear diagnostic with native state readback; in-game revalidation is still required. VFX/AoE remain unavailable.
